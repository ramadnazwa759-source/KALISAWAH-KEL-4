            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="bg-light rounded-3 p-2 me-3" style="width: 50px; height: 50px; display: flex; align-items: center; justify-content: center;">
                                        <img src="{{ asset('storage/' . $item->gambar) }}"
                                             width="40" height="40"
                                             alt="icon" style="object-fit: cover; border-radius: 4px;">
                                    </div>
                        ...
                        <!-- MODAL EDIT (Dibuat di dalam loop agar tiap data punya modal sendiri) -->
                                    ...
                                    <form action="{{ route('admin.kategori-paket.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body px-4">
                                            <div class="mb-3 text-center">
                                                <label class="d-block mb-2 text-muted small">Gambar Saat Ini</label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label fw-bold">Ubah Gambar (Opsional)</label>
        ...
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <form action="{{ route('admin.kategori-paket.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body px-4">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nama Kategori</label>
                        <input type="text" name="nama_kategori" class="form-control rounded-3" placeholder="Contoh: Arung Jeram" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Deskripsi</label>
                        <textarea name="deskripsi" class="form-control rounded-3" rows="4" placeholder="Deskripsi kategori..." required></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Icon/Gambar</label>
