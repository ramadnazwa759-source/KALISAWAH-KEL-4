...
@section('title', 'Detail Pemesanan Paintball - Kalisawah Adventure')
...
@section('content')
    ...
    <section id="ringkasan" class="py-24 px-6 bg-[#F8FAFC]">
        <div class="max-w-[850px] mx-auto">
            ...
            <div class="mb-12 text-center">
                <h2 class="text-3xl md:text-4xl font-black text-dark-navy mb-3">Rincian Reservasi Paintball</h2>
            ...
            <div class="bg-white rounded-[32px] shadow-xl p-8 md:p-12 border border-gray-100 space-y-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    ...
                    <div class="space-y-8">
                        <div>
                            <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-[0.1em] mb-2 ml-1">Jumlah Peserta</label>
                            <p id="display_peserta" class="text-2xl font-black text-dark-navy border-b-2 border-gray-50 pb-2">- Orang</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="pricing_container" class="pt-12 border-t-2 border-gray-100">
                    ...
                    <p class="mt-4 text-center text-gray-400 text-sm italic font-medium">*Seluruh biaya sudah termasuk instruktur, senjata, dan peluru paintball.</p>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                if (config) {
                    ...
                    priceItemsContainer.innerHTML += `
                        <div class="flex justify-between items-center text-lg">
                            <span class="text-gray-500 font-bold">${pkg.name} (${pkg.qty} Orang x ${formatIDR(config.price)})</span>
            ...
            // Save the calculated totalHarga back to localStorage for payment page
        ...
        function goToPayment() {
            ...
            setTimeout(() => {
                window.location.href = "{{ url('pembayaran-paintball') }}";
            }, 800);
        }
    </script>
@endsection
