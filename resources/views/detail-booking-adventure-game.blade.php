...
@section('title', 'Detail Pemesanan Adventure Game - Kalisawah Adventure')
...
@section('content')
    ...
    <section class="relative h-[60vh] min-h-[500px] w-full overflow-hidden flex items-center justify-center text-center">
        ...
        <div class="relative z-10 px-6 max-w-5xl mx-auto pt-20">
            <h1 id="hero_title" class="text-white text-4xl md:text-6xl font-bold mb-6 leading-tight uppercase tracking-tight">
                ADVENTURE GAME
            </h1>
            <p id="hero_subtitle" class="text-gray-200 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
                Periksa kembali detail reservasi adventure game Anda.
            </p>
        </div>
    </section>
    ...
    <section id="ringkasan" class="py-24 px-6 bg-[#F8FAFC]">
        <div class="max-w-[850px] mx-auto">
            ...
            <div class="bg-white rounded-[32px] shadow-xl p-8 md:p-12 border border-gray-100 space-y-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div class="space-y-8">
                        ...
                        <div>
                            <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-[0.1em] mb-2 ml-1">Jumlah</label>
            ...
            <div class="mt-24 pt-12 pb-40 flex flex-row flex-nowrap items-center justify-between gap-4 md:gap-8 border-t-2 border-gray-200">
                <a href="{{ route('booking-adventure-game') }}" 
    ...
    <script>
            ...
            data.selected_packages.forEach(pkg => {
                ...
                packageListContainer.innerHTML += `
                    <div class="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-gray-100">
                        ...
                        <span class="bg-white px-4 py-1 rounded-lg text-primary font-black shadow-sm">${pkg.qty} Paket</span>
                    </div>
                `;
        ...
        function goToPayment() {
            ...
            setTimeout(() => {
                window.location.href = "{{ route('pembayaran.adventure') }}";
            }, 800);
        }
    </script>
@endsection
