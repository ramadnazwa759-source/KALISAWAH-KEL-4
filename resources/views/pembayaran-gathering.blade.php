...
@section('title', 'Pembayaran Gathering - Kalisawah Adventure')
...
@section('content')
    ...
    <section class="relative h-[80vh] min-h-[600px] w-full overflow-hidden flex items-center justify-center text-center">
        ...
        <div class="relative z-10 px-6 max-w-5xl mx-auto pt-20">
            ...
            <p class="text-gray-200 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed drop-shadow-lg">
                Siapkan Keseruan Corporate Event & Outing Bersama Kalisawah Adventure!
            </p>
        </div>
    </section>
    ...
    <section id="pembayaran" class="py-24 px-6 bg-[#F8FAFC] scroll-mt-20 relative">
        <div class="max-w-[850px] mx-auto relative z-10">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <button onclick="copyToClipboard('1220011966838')" class="text-gray-400 hover:text-primary transition-colors active:scale-90 duration-100">
            ...
            <div class="mt-24 pt-12 pb-40 flex flex-row flex-nowrap items-center justify-between gap-4 md:gap-8 border-t border-gray-100">
                <a href="{{ url('/detail-booking-gathering') }}" 
                    class="btn-action flex-1 md:flex-none md:w-[280px] h-[55px] rounded-xl border border-blue-400 bg-white text-primary font-bold text-lg flex items-center justify-center hover:bg-blue-50 transition-all duration-200 active:scale-[0.98] uppercase tracking-widest text-center">
                    Kembali
                </a>
    ...
    <div id="loadingOverlayPayment" class="fixed inset-0 z-[200] bg-primary/95 hidden items-center justify-center flex-col text-white backdrop-blur-md">
        ...
        <h3 class="text-3xl font-black mb-2">Memproses Pembayaran</h3>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!data || !data.nama_pemesan || !data.selected_packages || data.category !== 'gathering') {
                return;
            }
            ...
            let totalPax = data.jumlah_peserta || 0;
            let totalHarga = 0;
        ...
        function confirmPayment() {
            ...
            if (data) {
                data.metode_pembayaran = document.getElementById('paymentTypeSelect').value;
                localStorage.setItem('booking_data', JSON.stringify(data));
            }

            setTimeout(() => {
                window.location.href = "{{ url('/status-booking-gathering') }}";
            }, 1500);
        }
