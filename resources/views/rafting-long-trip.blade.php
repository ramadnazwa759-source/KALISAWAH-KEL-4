...
@section('title', 'Long Trip Rafting - Kalisawah Adventure')

@section('content')
    <!-- HERO SECTION -->
    <section class="relative h-[60vh] min-h-[400px] w-full overflow-hidden">
        <img src="{{ asset('images/raft3.jpg') }}" alt="Long Trip Rafting" class="absolute inset-0 w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/60"></div>
        <div class="relative z-10 h-full flex items-center px-6 md:px-20 lg:px-32 max-w-7xl mx-auto pt-20">
            <div class="max-w-2xl">
                <div class="inline-block bg-blue-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest shadow-lg mb-6">
                    Lebih Aman Lebih Puas
                </div>
                <h1 class="text-white text-4xl md:text-6xl font-black mb-4 uppercase leading-tight">LONG TRIP</h1>
                <p class="text-gray-200 text-lg font-medium leading-relaxed">
                    Pengalaman rafting terjauh dan terlengkap menyusuri keindahan Sungai Badeng selama 3 - 3.5 jam.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="lg:col-span-2 space-y-12">
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed text-lg">
                        Paket Long Trip adalah pilihan terbaik bagi Anda yang ingin menikmati sensasi rafting secara maksimal. Dengan jarak tempuh ± 6 Km, Anda akan diajak menyusuri jeram-jeram menantang sekaligus pemandangan alam yang eksotis di sepanjang Sungai Badeng.
                    </p>
                </div>
                ...
                <div class="bg-white p-10 rounded-[40px] border border-gray-100 shadow-2xl sticky top-32">
                    <div class="mb-8">
                        ...
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-dark-navy">Rp 250k</span>
                            <span class="text-gray-400 font-bold">/ Pax</span>
                        </div>
                        <p class="text-[10px] text-gray-400 font-bold uppercase mt-2 tracking-widest">(WNA Rp 350.000)</p>
                    </div>

                    <a href="{{ route('booking.rafting') }}?paket=long-trip" class="w-full bg-secondary text-white py-5 rounded-2xl font-black text-sm uppercase tracking-widest flex items-center justify-center gap-3 hover:opacity-90 transition-all active:scale-[0.98] shadow-xl shadow-secondary/20 mb-6">
                        Booking Sekarang
                    ...
                    <div class="space-y-4 pt-6 border-t border-gray-100">
                        ...
                        <div class="flex items-center gap-3 text-gray-400">
                            ...
                            <span class="text-[10px] font-bold uppercase tracking-wider">Bantuan 24 Jam</span>
                        </div>
                    </div>
                </div>
            </div>
