...
@section('title', 'Status Booking Gathering - Kalisawah Adventure')

@section('content')
    <!-- HERO SECTION (Decorative/Small) -->
    <section class="relative h-[100px] w-full overflow-hidden">
        <img src="{{ asset('images/outbond.jpg') }}" onerror="this.src='https://picsum.photos/1920/1080?random=1'" alt="Hero Background" class="absolute inset-0 w-full h-full object-cover object-top">
        ...
        <div class="max-w-[850px] mx-auto">
            ...
            <div class="bg-white rounded-[32px] shadow-xl p-8 md:p-12 border border-gray-100 space-y-12">
                ...
                <div class="flex flex-row flex-nowrap items-center justify-center gap-4 pt-16 pb-20">
                    <a href="{{ url('/pembayaran-gathering') }}" 
                        class="btn-action flex-1 md:flex-none md:w-[280px] h-[55px] rounded-xl border border-blue-400 bg-white text-primary font-bold text-lg flex items-center justify-center hover:bg-blue-50 transition-all duration-200 active:scale-[0.98] shadow-sm uppercase tracking-widest text-center">
                        Kembali
                    </a>
