...
@section('title', 'Detail Pemesanan Gathering - Kalisawah Adventure')
...
@section('content')
    ...
    <section id="ringkasan" class="py-24 px-6 bg-[#F8FAFC]">
        <div class="max-w-[850px] mx-auto">
            ...
            <div class="mb-12 text-center">
                <h2 class="text-3xl md:text-4xl font-black text-dark-navy mb-3">Rincian Reservasi Gathering</h2>
            ...
            <div class="bg-white rounded-[32px] shadow-xl p-8 md:p-12 border border-gray-100 space-y-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div class="space-y-8">
                        ...
                        <div>
                            <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-[0.1em] mb-2 ml-1">Jumlah Pax</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let totalHarga = 0;
            let totalPax = data.jumlah_peserta || 0; // for gathering, pax applies to all selected packages globally
            ...
            data.selected_packages.forEach(pkg => {
                ...
                // Since gathering packages use global 'jumlah_peserta', the qty inside pkg is that same number.
                ...
                packageListContainer.innerHTML += `
                    <div class="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-gray-100">
                        ...
                        <span class="bg-white px-4 py-1 rounded-lg text-primary font-black shadow-sm">${pkg.qty} Pax</span>
                    </div>
                `;
        ...
        function goToPayment() {
            ...
            setTimeout(() => {
                window.location.href = "{{ url('/pembayaran-gathering') }}";
            }, 800);
        }
    </script>
@endsection
