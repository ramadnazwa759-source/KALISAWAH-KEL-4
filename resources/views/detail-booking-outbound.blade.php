...
@section('title', 'Detail Pemesanan Outbound - Kalisawah Adventure')
...
@section('content')
    ...
    <section id="ringkasan" class="py-24 px-6 bg-[#F8FAFC]">
        <div class="max-w-[850px] mx-auto">
            ...
            <div class="mb-12 text-center">
                <h2 class="text-3xl md:text-4xl font-black text-dark-navy mb-3">Rincian Reservasi Outbound</h2>
    ...
    <script>
        ...
        function goToPayment() {
            ...
            setTimeout(() => {
                window.location.href = "{{ route('pembayaran.outbound') }}";
            }, 800);
        }
    </script>
@endsection
