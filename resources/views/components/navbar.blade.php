<nav class="fixed top-0 left-0 right-0 z-[999] transition-all duration-300 bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-100 py-4 px-6 md:px-20 flex justify-between items-center">
    <div class="flex items-center">
        <a href="{{ route('landing-page.home') }}">
            <img src="{{ asset('images/logoKalisawah.png') }}" alt="Kalisawah Adventure" class="h-10 md:h-12" onerror="this.src='https://picsum.photos/150/50'">
        </a>
    </div>

    <ul class="hidden lg:flex gap-8 items-center list-none m-0 p-0 font-semibold text-primary">
        <li><a href="{{ route('landing-page.home') }}" class="hover:text-hover-primary transition-colors">Beranda</a></li>
        
        <li class="relative dropdown">
            <button id="desktop-dropdown-btn" class="flex items-center gap-1 hover:text-hover-primary transition-colors outline-none focus:outline-none py-2 cursor-pointer bg-transparent border-none font-semibold text-primary">
            ...
            <ul id="desktop-dropdown-menu" class="hidden absolute left-0 top-full mt-0 w-64 bg-white border-t-4 border-primary rounded-b-xl shadow-2xl py-3 list-none transform translate-y-2 transition-all duration-300 opacity-0">
                ...
                <li><a href="{{ route('paintball') }}" class="block px-6 py-3 hover:bg-soft-blue text-sm transition-colors text-gray-700 font-medium hover:text-primary">Paintball</a></li>
        ...
        <li><a href="{{ url('/#paket-seru') }}" class="hover:text-hover-primary transition-colors">Aktivitas</a></li>
    ...
    <div class="flex items-center gap-4">
        <button onclick="toggleMobileMenu()" class="lg:hidden text-primary text-2xl focus:outline-none bg-transparent border-none cursor-pointer">
    ...
    <div id="mobile-menu" class="hidden lg:hidden absolute top-full left-0 right-0 bg-white shadow-2xl border-t border-gray-100 py-6 px-6 space-y-4 max-h-[80vh] overflow-y-auto">
        <a href="{{ route('landing-page.home') }}" class="block font-bold text-primary">Beranda</a>
        
        <div class="space-y-2">
            <button onclick="toggleMobileDropdown()" class="w-full flex justify-between items-center font-bold text-primary border-b border-gray-100 pb-2 bg-transparent border-t-0 border-x-0 outline-none cursor-pointer">
            ...
            <ul id="mobile-dropdown" class="hidden pl-4 space-y-3 list-none mt-2 border-l-2 border-soft-blue">
                ...
                <li><a href="{{ route('paintball') }}" class="block text-sm text-gray-600 hover:text-primary">Paintball</a></li>
        ...
        <a href="{{ url('/#paket-seru') }}" class="block font-bold text-primary">Aktivitas</a>
