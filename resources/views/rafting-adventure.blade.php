...
@section('title', 'Adventure Rafting - Kalisawah Adventure')

@section('content')
    <!-- HERO SECTION -->
    <section class="relative h-[60vh] min-h-[400px] w-full overflow-hidden">
        <img src="{{ asset('images/raft2.jpg') }}" alt="Adventure Rafting" class="absolute inset-0 w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/60"></div>
        <div class="relative z-10 h-full flex items-center px-6 md:px-20 lg:px-32 max-w-7xl mx-auto pt-20">
            <div class="max-w-2xl">
                <div class="inline-block bg-secondary text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest shadow-lg mb-6">
                    Paling Laris
                </div>
                <h1 class="text-white text-4xl md:text-6xl font-black mb-4 uppercase leading-tight">ADVENTURE</h1>
                <p class="text-gray-200 text-lg font-medium leading-relaxed">
                    Paket favorit dengan tantangan jeram Sungai Badeng yang pas untuk petualangan seru selama 1.5 - 2 jam.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 px-6 md:px-20 max-w-7xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div class="lg:col-span-2 space-y-12">
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed text-lg">
                        Paket Adventure adalah paket yang paling banyak diminati oleh pengunjung Kalisawah Adventure. Menawarkan keseimbangan antara tantangan jeram yang memacu adrenalin dan durasi yang ideal bagi Anda yang ingin merasakan rafting namun tetap memiliki waktu untuk aktivitas lainnya.
                    </p>
                </div>
                    ...
                    <div class="bg-gray-50 p-8 rounded-[32px] border border-gray-100">
                        ...
                        <ul class="space-y-4">
                            ...
                            <li class="flex items-center gap-4 text-gray-600 font-bold">
                                ...
                                <span>Makan 1x & Snack 1x</span>
                            </li>
                            <li class="flex items-center gap-4 text-gray-600 font-bold">
                                <i class="fa-solid fa-bottle-water text-green-500 w-6 text-center"></i>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white p-10 rounded-[40px] border-2 border-secondary shadow-2xl sticky top-32">
                    <div class="mb-8">
                        <span class="text-gray-400 text-xs font-bold uppercase tracking-widest block mb-2">Harga Per Orang</span>
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-dark-navy">Rp 165k</span>
                            <span class="text-gray-400 font-bold">/ Pax</span>
                        </div>
                        <p class="text-[10px] text-gray-400 font-bold uppercase mt-2 tracking-widest">(WNA Rp 250.000)</p>
                    </div>

                    <a href="{{ route('booking.rafting') }}?paket=adventure" class="w-full bg-secondary text-white py-5 rounded-2xl font-black text-sm uppercase tracking-widest flex items-center justify-center gap-3 hover:opacity-90 transition-all active:scale-[0.98] shadow-xl shadow-secondary/20 mb-6">
                        Booking Sekarang
                    ...
                    <div class="space-y-4 pt-6 border-t border-gray-100">
                        <div class="flex items-center gap-3 text-gray-400">
                            ...
                            <span class="text-[10px] font-bold uppercase tracking-wider">Paket Paling Laris</span>
                        </div>
                        <div class="flex items-center gap-3 text-gray-400">
